...
const GET_OUTPATIENTS_BY_DOCTOR_ID: string = BASE_EMR_URL + 'patientDoctor/getAllOutpatientsByDoctorID/'
const GET_INPATIENTS_BY_DOCTOR_ID: string = BASE_EMR_URL + 'patientDoctor/getAllInpatientsByDoctorID/'
...
const GET_PATIENTS_BY_NURSE_ID: string = BASE_URL+ 'patientDepartment/getAllPatientsByNurseID/'
export {
    BASE_AUTH_URL,
    BASE_URL,
    LOGIN,
